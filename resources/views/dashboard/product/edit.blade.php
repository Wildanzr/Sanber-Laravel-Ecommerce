...
<div class="card mb-4">
    <div class="formcreate m-5">
        <form action="{{ url('product/{product_id}/edit') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{ $prduct->description }}" id="exampleInputPassword1" name="description">
            </div>
            @error('description')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
